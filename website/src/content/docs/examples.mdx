...
|---|---|
| **Channel composition** | One `beryl_channels.child_spec` handler table owns `cursor:*`, `room:*`, and the `document:` prefix |
...
| **Shared presence** | One session-presence tracker is reused across the embedded apps that need it |
