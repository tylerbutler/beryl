...
<div class="beryl-path">
	<ol>
		...
		<li>
			...
			<p>Wire up one typed <code>init</code>/<code>update</code> pair, the WebSocket transport, and a Phoenix JS client, end to end, in one sitting.</p>
...
<div class="beryl-features">
	<article class="beryl-feature beryl-feature--lead">
		<h3>App-side dispatch</h3>
		<p>Route every socket event through one typed <code>update</code> function you own. Match topics, thread your own model, and return ordered effects with compile-time guarantees — no registry, no assigns, no type erasure.</p>
		<a class="beryl-feature__link" href="/guides/dispatch/">Dispatch guide →</a>
	</article>
