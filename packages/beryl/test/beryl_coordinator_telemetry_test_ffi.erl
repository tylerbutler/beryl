-module(beryl_coordinator_telemetry_test_ffi).
-export([
    attach/0,
    detach/1,
    expect_connected/1,
...
%% Test inputs are closed literals. Convert only to atoms already loaded by
%% this module; never create atoms from arbitrary input.
expected_atom(Value) ->
