...
pub fn same_origin_without_origin_header_is_admitted_test() {
...
pub fn same_origin_without_host_header_fails_closed_test() {
  origin.allowed(
    policy: origin.SameOrigin,
...
pub fn allow_list_requires_exact_match_test() {
...
pub fn allow_all_admits_everything_test() {
