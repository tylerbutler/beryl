...
| `503` | `{"error":"coordinator_unavailable"}` | Beryl socket runtime unavailable |
| `503` | `{"error":"runtime_stats_unavailable"}` | BEAM snapshot FFI failed |
| `504` | `{"error":"coordinator_timeout"}` | Socket runtime snapshot request timed out |
