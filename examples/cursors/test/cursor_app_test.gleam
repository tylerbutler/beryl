...
pub fn supported_reactions_broadcast_test() -> Nil {
  ["👍", "❤️", "😂", "🎉", "🔥"]
...
pub fn integer_boundary_coordinates_broadcast_test() -> Nil {
  let #(_, effects) =
    app.update(
      context(),
      "socket-1",
...
pub fn invalid_reaction_payloads_are_dropped_test() -> Nil {
  let missing_y =
    dynamic.properties([
...
pub fn cursor_move_behavior_is_unchanged_test() -> Nil {
  let payload =
    dynamic.properties([
